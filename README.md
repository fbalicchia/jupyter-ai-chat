...
This extension is composed of a Python package named `jupyter_ai_chat`
that exposes the model engines to the Jupyter AI server extension,
and an NPM package named `jupyter-ai-chat`
...
# Change directory to the jupyter_ai_chat directory
...
folder is located. Then you can remove the symlink named `jupyter-ai-chat` within that folder.
